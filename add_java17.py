...
with open('src/data/java17.ts', 'r') as f:
    content = f.read()
...
content = content.replace("export const java17Questions: QuestionItem[] = [", "export const java17Questions: QuestionItem[] = [\n" + new_questions)

with open('src/data/java17.ts', 'w') as f:
    f.write(content)
